...
public enum CurationType {
    ...
    CAPSULE_FLAVOR(true, "capsule essentials; mood ", "note", null),
    CAPSULE_PERSONAL(true, "님에게 알맞는 캡슐", "preference", null),
    ...
    COFFEE_FLAVOR(false, "coffee essentials; mood ", "note", null),
    COFFEE_PERSONAL(false, "님에게 알맞는 원두들", "preference", null);
