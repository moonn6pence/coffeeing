  ...
  const data = [
    {
      src: coffeeBean,
      label: '원두',
      isSelected: selectedBean,
      setIsSelected: setSelectedBean,
      num: 0,
    },
    {
      src: coffeeCapsule,
      label: '캡슐',
      isSelected: selectedCapsule,
      setIsSelected: setSelectedCapsule,
      num: 1,
    },
  ];
  // 로스팅 단계 이미지 클릭 시
          ...
          return (
            ...
            >
              <img
                ...
                src={src}
                onClick={() =>
                  handleCoffeeSelect(num, isSelected, setIsSelected)
                }
              />
