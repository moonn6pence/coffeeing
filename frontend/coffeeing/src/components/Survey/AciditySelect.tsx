...
export const AciditySelect = () =>{
  ...
  // 데이터
  const data = [
    {src:noAcid, label:'없음', isSelected:selectedNoAcid, setIsSelected:setSelectedNoAcid,num:0.25},
    {src:lowAcid, label:'낮음', isSelected:selectedLowAcid, setIsSelected:setSelectedLowAcid,num:0.5},
    {src:mediumAcid, label:'중간', isSelected:selectedMediumAcid, setIsSelected:setSelectedMediumAcid,num:0.75},
    {src:highAcid, label:'높음', isSelected:selectedHighAcid, setIsSelected:setSelectedHighAcid,num:1},
  ]
  // 산미 단계 이미지 클릭 시
