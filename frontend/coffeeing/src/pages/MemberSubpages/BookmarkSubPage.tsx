...
export const BookmarkSubPage = () => {
  ...
  const getBookmark = () => {
    ...
    privateRequest.get(`${API_URL}/member/${beans}/bookmark/${id}`, {params: {page : 0}})
    .then((res)=>{
  ...
  return (
    <div className="bg-light p-12">
      ...
      <PaginationNew currentPage={currentPage} totalPage={totalPage} isCapsule={isCapsule} setCurrentPage={()=>{return}} products={bookmarkList} />
    </div>
  );
};
